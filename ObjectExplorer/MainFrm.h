...
public:
	...
	virtual BOOL TrackPopupMenu(HMENU hMenu, HWND hWnd) override;
	...
	BEGIN_MSG_MAP(CMainFrame)
		...
		COMMAND_RANGE_HANDLER(ID_SHOWOBJECTSOFTYPE_PROCESS, ID_SHOWOBJECTSOFTYPE_PROCESS + 15, OnShowObjectOfType)
