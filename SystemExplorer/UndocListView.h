...
struct __declspec(uuid("{88EB9442-913B-4AB4-A741-DD99DCB7558B}")) IListViewFooterCallback : IUnknown {
...
struct __declspec(uuid("{F0034DA8-8A22-4151-8F16-2EBA76565BCC}")) IListViewFooter : IUnknown {
